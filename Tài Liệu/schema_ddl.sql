...
CREATE TABLE syllabus (
  ...
  language       VARCHAR(100) DEFAULT 'English' COMMENT 'Ngôn ngữ giảng dạy',
  course_objectives TEXT COMMENT 'Mục tiêu môn học',
  teaching_methods  TEXT COMMENT 'Phương pháp giảng dạy chung',
  study_requirements TEXT COMMENT 'Yêu cầu học tập',
  examination_requirements TEXT COMMENT 'Yêu cầu kiểm tra/thi',
  workload_description TEXT COMMENT 'Mô tả khối lượng học tập',
  relation_to_curriculum VARCHAR(255) COMMENT 'Vị trí/liên hệ với chương trình đào tạo',
  status         ENUM(
...
CREATE TABLE class_section (
  ...
  course_id      INT          NOT NULL                COMMENT 'Học phần',
  syllabus_id    INT          NOT NULL                COMMENT 'Đề cương sử dụng học kỳ này',
