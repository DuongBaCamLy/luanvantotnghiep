...
export const prefixFor = (role: UserRole) => `/${role.toLowerCase().replace("dept_head", "dept-head")}`
      ...
      items: [
        {
          ...
          children: [
            {
              label: "Syllabus Catalog",
              path: `${root}/syllabus`,
            },
          ],
        },

        ...(role === "DEPT_HEAD" || role === "DEAN"
          ? [
              {
                label:
                  role === "DEAN"
